...
urlpatterns = [
     ...
     path('my-info/<str:collection>/', views.user_collections, name='user_collections'),
     path('my-collections/update', views.update_tesera_collection,
          name='update_collection'),
     path('my-meetings/', views.user_meetings, name='user_meetings'),
     path('my-meetings/<status>/', views.user_meetings, name='user_meetings_s'),
     ...
     path('profile-<slug:username>/<str:collection>', views.gamer_collections, name='gamer_collections'),
